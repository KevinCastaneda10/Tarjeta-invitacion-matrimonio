...
//           <h3 className="text-3xl md:text-3xl font-extrabold text-emerald-950 mb-6 italic">
//             La boda será el 9 de noviembre
//           </h3>
//           <h4 className="text-3xl md:text-3xl font-extrabold text-emerald-950 mb-6 italic">
//             Faltan:
//           </h4>

//           {/* Cuenta regresiva */}
//           <div className="text-3xl md:text-6xl font-bold text-yellow-900 bg-white py-4 px-8 rounded-lg shadow-lg inline-block">
...
//           <h1 className="text-4xl font-bold mb-10 text-emerald-950">
...
//               Padres de la novia
//             </h3>
//             <p className="text-xl italic">Nelson y Miryam</p>
...
//         <h3 className="text-3xl font-bold mb-6">Regalo</h3>
...
//         {/* Título "Con amor" */}
//         <h3 className="text-4xl font-bold mb-4 text-emerald-950 tracking-wide">
//           Con amor,
//         </h3>

//         {/* Nombres con estilo cursivo */}
//         <p className="text-3xl italic text-yellow-900">Viviana & Jhon</p>
...
const Invitation = () => {
  ...
  return (
    <div className="italic">
      ...
      {/*sección canción*/}
      <section className="py-8 bg-custom-gray text-gray-800">
        <div className="max-w-80 mx-auto text-center px-4 bg-gray-700 rounded-xl text-white">
          <div className="flex items-center justify-center space-x-4">
            <button onClick={togglePlay} className=" p-2 rounded-full">
              {isPlaying ? (
                <span>❚❚</span> // Ícono de pausa
              ) : (
                <span>▶</span> // Ícono de reproducción
              )}
            </button>
            <audio ref={audioRef} src="/Por_Toda_la_Vida.mp3" />
            <span>
      ...
      <section className="py-8 text-center bg-custom-gray text-yellow-900">
        ...
        <div className="flex flex-col mt-6 md:flex-row justify-center items-center gap-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2">Vestido formal</p>
            <p className="mt-2 text-gray-700">
              &quot;Nota: Se reservará el color rojo para las damas de honor.&quot;
            </p>
          </div>
        </div>
      </section>
